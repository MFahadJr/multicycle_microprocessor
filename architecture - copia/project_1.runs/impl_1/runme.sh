...
HD_PWD='E:/Estudis/Universitat estudis/Q7/Investigation_work/micro_multicycle/architecture/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiply_Cycle_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiply_Cycle_Processor.tcl -notrace
