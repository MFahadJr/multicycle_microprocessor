...
HD_PWD='E:/Estudis/Universitat estudis/Q7/Investigation_work/micro_multicycle/architecture/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiply_Cycle_Processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiply_Cycle_Processor.tcl
